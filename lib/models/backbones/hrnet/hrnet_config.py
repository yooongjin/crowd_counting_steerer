...
# configs for HR-NAS
HR_NAS = CN()
HR_NAS.STEM_INPLANES = 64
HR_NAS.FINAL_CONV_KERNEL = 1
HR_NAS.WITH_HEAD = True

HR_NAS.STAGE1 = CN()
HR_NAS.STAGE1.NUM_MODULES = 1
HR_NAS.STAGE1.NUM_BRANCHES = 1
HR_NAS.STAGE1.NUM_BLOCKS = [4]
HR_NAS.STAGE1.NUM_CHANNELS = [64]
HR_NAS.STAGE1.BLOCK = "BOTTLENECK"
HR_NAS.STAGE1.FUSE_METHOD = "SUM"

HR_NAS.STAGE2 = CN()
HR_NAS.STAGE2.NUM_MODULES = 1
HR_NAS.STAGE2.NUM_BRANCHES = 2
HR_NAS.STAGE2.NUM_BLOCKS = [4, 4]
HR_NAS.STAGE2.NUM_CHANNELS = [48, 96]
HR_NAS.STAGE2.BLOCK = "BASIC"
HR_NAS.STAGE2.FUSE_METHOD = "SUM"

HR_NAS.STAGE3 = CN()
HR_NAS.STAGE3.NUM_MODULES = 4
HR_NAS.STAGE3.NUM_BRANCHES = 3
HR_NAS.STAGE3.NUM_BLOCKS = [4, 4, 4]
HR_NAS.STAGE3.NUM_CHANNELS = [48, 96, 192]
HR_NAS.STAGE3.BLOCK = "BASIC"
HR_NAS.STAGE3.FUSE_METHOD = "SUM"

HR_NAS.STAGE4 = CN()
HR_NAS.STAGE4.NUM_MODULES = 3
HR_NAS.STAGE4.NUM_BRANCHES = 4
HR_NAS.STAGE4.NUM_BLOCKS = [4, 4, 4, 4]
HR_NAS.STAGE4.NUM_CHANNELS = [48, 96, 192, 384]
HR_NAS.STAGE4.BLOCK = "BASIC"
HR_NAS.STAGE4.FUSE_METHOD = "SUM"
