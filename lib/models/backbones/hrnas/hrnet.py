...
from .mobilenet_base import _make_divisible
from .mobilenet_base import ConvBNReLU
from .mobilenet_base import get_active_fn
from .mobilenet_base import InvertedResidualChannels, InvertedResidualChannelsFused
...
class HRNASBackbone(object):
    ...
    def __call__(self):
        ...
        if arch in [
            ...
            # arch_net = HighResolutionNet(**MODEL_CONFIGS[arch])
            arch_net = HighResolutionNet(active_fn= 'nn.ReLU',
                                        num_classes= 150,
                                        width_mult= 1.0,
                                        round_nearest= 2,
                                        input_stride= 4,
